function InsultCtrl(titleCase) {
   ...
   this.insult = titleCase.caps(this.generateInsult());
}
...
InsultCtrl.prototype.replaceInsult= function (){
  ...
  this.insult = this.titleCase.caps(randomAdjective1 + ' ' + randomAdjective2 + ' ' + randomNoun);  
}

angular.module('insultApp').controller('InsultCtrl', ['titleCase',InsultCtrl]);